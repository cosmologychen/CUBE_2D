module parameters
  ...
  ! output directory
  character(*),parameter :: opath='/Users/chenbinghang/Library/CloudStorage/OneDrive-个人/陈冰航/天文/sim_2D/3000_3072/'
...
# endif
  ...
  real,parameter :: np_halo_min=5 ! minimum number of particles to be a halo
